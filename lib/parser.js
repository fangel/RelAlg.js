...
var $0 = $$.length - 1;
switch (yystate) {
case 1: return yy.AST.call(this, 'Assignment', $$[$0-3], $$[$0-1]); 
break;
case 2: return yy.AST.call(this, 'Assignment', 'it', $$[$0-1]); 
break;
case 3: this.$ = yy.AST.call(this, 'RelationReference', yytext); 
break;
case 4: this.$ = $$[$0]; 
break;
case 5: this.$ = yy.AST.call(this, 'Union', $$[$0-2], $$[$0] ); 
break;
case 6: this.$ = yy.AST.call(this, 'Intersection', $$[$0-2], $$[$0] ); 
break;
case 7: this.$ = yy.AST.call(this, 'Difference', $$[$0-2], $$[$0] ); 
break;
case 8: this.$ = yy.AST.call(this, 'Cartesian', $$[$0-2], $$[$0] ); 
break;
case 9: this.$ = yy.AST.call(this, 'Join', $$[$0-5], $$[$0-2], $$[$0] ); 
break;
case 10: this.$ = yy.AST.call(this, 'NaturalJoin', $$[$0-2], $$[$0] ); 
break;
case 11: this.$ = yy.AST.call(this, 'Division', $$[$0-2], $$[$0] ); 
break;
case 12: this.$ = $$[$0-1] 
break;
case 13: this.$ = yy.AST.call(this, 'Projection', $$[$0-4], $$[$0-1] ); 
break;
case 14: this.$ = yy.AST.call(this, 'Rename', $$[$0-1], $$[$0-6], $$[$0-4] ); 
break;
case 15: this.$ = yy.AST.call(this, 'Selection', $$[$0-4], $$[$0-1] ); 
break;
case 16: this.$ = yy.AST.call(this, 'ProjectionList', $$[$0] ); 
break;
case 17: this.$ = $$[$0-2].add($$[$0]); 
break;
case 18: this.$ = yy.AST.call(this, 'Criteria', $$[$0-2], $$[$0-1], $$[$0]); 
break;
case 19: this.$ = yy.AST.call(this, 'CriteriaComposition', $$[$0-2], 'AND', $$[$0]); 
break;
case 20: this.$ = yy.AST.call(this, 'CriteriaComposition', $$[$0-2], 'OR', $$[$0]); 
break;
case 21: this.$ = $$[$0-1]; 
break;
case 22: this.$ = yy.AST.call(this, 'Attribute', yytext); 
break;
case 23: this.$ = yy.AST.call(this, 'Value', yytext.substring(1, yytext.length - 1)); 
break;
case 24: this.$ = yy.AST.call(this, 'Value', parseFloat(yytext)); 
break;
case 25: this.$ = yy.AST.call(this, 'Value', parseInt(yytext, 10)); 
break;
case 26: this.$ = yy.AST.call(this, 'Relation', new yy.Relation($$[$0-4], $$[$0-1])); 
break;
case 27: this.$ = [$$[$0-1]]; 
break;
