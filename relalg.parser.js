...
switch( state )
{
	case 0:
		...
		else if( ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 79 ) || info.src.charCodeAt( pos ) == 81 || info.src.charCodeAt( pos ) == 84 || ( info.src.charCodeAt( pos ) >= 86 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 122 ) ) state = 8;
		else if( info.src.charCodeAt( pos ) == 91 ) state = 9;
		else if( info.src.charCodeAt( pos ) == 93 ) state = 10;
		else if( info.src.charCodeAt( pos ) == 33 ) state = 22;
		...
		else if( info.src.charCodeAt( pos ) == 85 ) state = 39;
		else if( info.src.charCodeAt( pos ) == 82 ) state = 43;
		else if( info.src.charCodeAt( pos ) == 83 ) state = 44;
		else if( info.src.charCodeAt( pos ) == 80 ) state = 46;
		else state = -1;
		break;
	...
	case 35:
		...
		else if( info.src.charCodeAt( pos ) == 105 ) state = 31;
		else state = -1;
		match = 18;
		match_pos = pos;
		break;
	...
	case 40:
		if( ( info.src.charCodeAt( pos ) >= 48 && info.src.charCodeAt( pos ) <= 57 ) || ( info.src.charCodeAt( pos ) >= 65 && info.src.charCodeAt( pos ) <= 90 ) || info.src.charCodeAt( pos ) == 95 || ( info.src.charCodeAt( pos ) >= 97 && info.src.charCodeAt( pos ) <= 109 ) || ( info.src.charCodeAt( pos ) >= 111 && info.src.charCodeAt( pos ) <= 122 ) ) state = 8;
		else if( info.src.charCodeAt( pos ) == 110 ) state = 36;
		else state = -1;
		match = 18;
		match_pos = pos;
		break;
	...
	case 42:
		...
		else if( info.src.charCodeAt( pos ) == 106 ) state = 38;
		else state = -1;
		match = 18;
		match_pos = pos;
		break;
...
var act_tab = new Array(
	/* State 0 */ new Array( 18/* "Identifier" */,3 , 14/* "(" */,4 , 2/* "Project" */,5 , 3/* "Rename" */,6 ),
	/* State 1 */ new Array( 26/* "$" */,0 ),
	/* State 2 */ new Array( 5/* "Union" */,7 , 26/* "$" */,-1 ),
	/* State 3 */ new Array( 26/* "$" */,-2 , 5/* "Union" */,-2 , 15/* ")" */,-2 ),
	/* State 4 */ new Array( 18/* "Identifier" */,3 , 14/* "(" */,4 , 2/* "Project" */,5 , 3/* "Rename" */,6 ),
	/* State 5 */ new Array( 16/* "[" */,9 ),
	/* State 6 */ new Array( 16/* "[" */,10 ),
	/* State 7 */ new Array( 18/* "Identifier" */,3 , 14/* "(" */,4 , 2/* "Project" */,5 , 3/* "Rename" */,6 ),
	/* State 8 */ new Array( 5/* "Union" */,7 , 15/* ")" */,12 ),
	/* State 9 */ new Array( 18/* "Identifier" */,14 ),
	/* State 10 */ new Array( 18/* "Identifier" */,16 ),
	/* State 11 */ new Array( 5/* "Union" */,7 , 26/* "$" */,-3 , 15/* ")" */,-3 ),
	/* State 12 */ new Array( 26/* "$" */,-4 , 5/* "Union" */,-4 , 15/* ")" */,-4 ),
	/* State 13 */ new Array( 7/* "," */,17 , 17/* "]" */,18 ),
	/* State 14 */ new Array( 17/* "]" */,-7 , 7/* "," */,-7 ),
	/* State 15 */ new Array( 7/* "," */,19 , 17/* "]" */,20 ),
	/* State 16 */ new Array( 6/* "->" */,21 ),
	/* State 17 */ new Array( 18/* "Identifier" */,22 ),
	/* State 18 */ new Array( 14/* "(" */,23 ),
	/* State 19 */ new Array( 18/* "Identifier" */,24 ),
	/* State 20 */ new Array( 14/* "(" */,25 ),
	/* State 21 */ new Array( 18/* "Identifier" */,26 ),
	/* State 22 */ new Array( 17/* "]" */,-8 , 7/* "," */,-8 ),
	/* State 23 */ new Array( 18/* "Identifier" */,3 , 14/* "(" */,4 , 2/* "Project" */,5 , 3/* "Rename" */,6 ),
	/* State 24 */ new Array( 6/* "->" */,28 ),
	/* State 25 */ new Array( 18/* "Identifier" */,3 , 14/* "(" */,4 , 2/* "Project" */,5 , 3/* "Rename" */,6 ),
	/* State 26 */ new Array( 17/* "]" */,-9 , 7/* "," */,-9 ),
	/* State 27 */ new Array( 5/* "Union" */,7 , 15/* ")" */,30 ),
	/* State 28 */ new Array( 18/* "Identifier" */,31 ),
	/* State 29 */ new Array( 5/* "Union" */,7 , 15/* ")" */,32 ),
	/* State 30 */ new Array( 26/* "$" */,-5 , 5/* "Union" */,-5 , 15/* ")" */,-5 ),
	/* State 31 */ new Array( 17/* "]" */,-10 , 7/* "," */,-10 ),
	/* State 32 */ new Array( 26/* "$" */,-6 , 5/* "Union" */,-6 , 15/* ")" */,-6 )
);
...
var goto_tab = new Array(
	...
	/* State 2 */ new Array(  ),
	/* State 3 */ new Array(  ),
	/* State 4 */ new Array( 22/* Stmt */,8 ),
	/* State 5 */ new Array(  ),
	/* State 6 */ new Array(  ),
	/* State 7 */ new Array( 22/* Stmt */,11 ),
	/* State 8 */ new Array(  ),
	/* State 9 */ new Array( 24/* ProjectionList */,13 ),
	/* State 10 */ new Array( 25/* RenameList */,15 ),
	/* State 11 */ new Array(  ),
	/* State 12 */ new Array(  ),
	/* State 13 */ new Array(  ),
	/* State 14 */ new Array(  ),
	...
	/* State 21 */ new Array(  ),
	/* State 22 */ new Array(  ),
	/* State 23 */ new Array( 22/* Stmt */,27 ),
	/* State 24 */ new Array(  ),
	/* State 25 */ new Array( 22/* Stmt */,29 ),
	/* State 26 */ new Array(  ),
	/* State 27 */ new Array(  ),
	/* State 28 */ new Array(  ),
	/* State 29 */ new Array(  ),
